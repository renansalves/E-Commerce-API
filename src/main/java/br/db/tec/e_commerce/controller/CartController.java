...
public class CartController {
	...
	@Operation(summary = "Remove produto por id", description = "Remove um item do carrinho, pelo seu id.")
	...
	@DeleteMapping
	@Operation(summary = "Remove os itens do carrinho", description = "Remove todos os itens do carrinho do usuário logado.")
